...
class TP_Tutor_Courses extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			// 	'columns',
			// 	[
			// 		'label' 	    => __( 'Number of Courses Per Row', 'larisdigital-wp' ),
			// 		'type' 		    => Controls_Manager::SELECT,
			// 		'default' 	    => 'default',
			// 		'options' 	    => [
			// 			'default'	=> 'default',
			...
			// 	'columns_tablet',
			// 	[
			// 		'label' 	    => __( 'Number of Courses Per Row (Tablet)', 'larisdigital-wp' ),
			// 		'type' 		    => Controls_Manager::SELECT,
			// 		'default' 	    => 'default',
			// 		'options' 	    => [
			// 			'default'	=> 'default',
			...
			// 	'columns_mobile',
			// 	[
			// 		'label' 	    => __( 'Number of Courses Per Row (Mobile)', 'larisdigital-wp' ),
			// 		'type' 		    => Controls_Manager::SELECT,
			// 		'default' 	    => 'default',
			// 		'options' 	    => [
			// 			'default'	=> 'default',
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<div <?php echo $this->get_render_attribute_string( 'carousel' ); ?>>
				...
				<?php while ( $query->have_posts() ) : $query->the_post(); ?>
					...
					<?php do_action('tutor_course/archive/before_loop_course'); ?>

					<?php tutor_load_template('loop.course'); ?>

					<?php do_action('tutor_course/archive/after_loop_course'); ?>
