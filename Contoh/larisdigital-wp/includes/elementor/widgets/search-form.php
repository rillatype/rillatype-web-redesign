...
class TP_Search_Form extends Widget_Base {

	public function get_name() {
		return 'tp_search_form';
	}

	public function get_title() {
		return __( 'TP - Search Form', 'larisdigital-wp' );
	}
	...
	public static function get_search_type() {
		$type = [
			'wordpress' => __( 'Default WordPress Search', 'larisdigital-wp' ),
		];
		if ( class_exists('woocommerce') ) {
			$type['woocommerce'] = __( 'WooCommerce Product Search', 'larisdigital-wp' );
		}
		return $type;
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_form',
			[
				'label' => __( 'Search Form', 'larisdigital-wp' ),
			]
		);
		...
		$this->add_control(
			'search_type',
			[
				'label' => __( 'Search Type', 'larisdigital-wp' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => true,
				'default' => 'wordpress',
				'options' => self::get_search_type(),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Search Placeholder', 'larisdigital-wp' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __( 'Type your search here', 'larisdigital-wp' ),
				'placeholder' => __( 'Type your search here', 'larisdigital-wp' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Search', 'larisdigital-wp' ),
				'placeholder' => __( 'Search', 'larisdigital-wp' ),
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'field_input', 'type', 'text' );
		$this->add_render_attribute( 'field_input', 'name', 's' );
		$this->add_render_attribute( 'field_input', 'required', '1' );
		$this->add_render_attribute( 'field_input', 'placeholder', $settings['field_input_placeholder'] );
		$this->add_render_attribute( 'field_input', 'value', '' );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<form role="search" class="tp-form" method="get" action="<?php echo esc_url( home_url( '/' ) ) ?>">
				<div class="tp-form-fields-wrapper">
					<div class="tp-form-field-input">
						<input <?php echo $this->get_render_attribute_string( 'field_input' ); ?>>
					</div>
				...
				<?php if ( class_exists('woocommerce') && $settings['search_type'] == 'woocommerce' ) : ?>
