...
class TP_EDD_Downloads extends Widget_Base {

	public function get_name() {
		return 'tp_edd_downloads';
	}

	public function get_title() {
		return __( 'TP - EDD Downloads', 'larisdigital-wp' );
	}
	...
	public static function get_product_categories() {
		...
		$terms = get_terms( array( 'taxonomy' => 'download_category' ) );
			...
			$this->add_control(
				...
				[
					...
					'options' 		=> [
						...
						'sales' 		=> __( 'Sales', 'larisdigital-wp' ),
						'earnings' 		=> __( 'Earnings', 'larisdigital-wp' ),
					],
					'condition'		=> [
			...
			<div <?php echo $this->get_render_attribute_string( 'carousel' ); ?>>
				...
				<?php while ( $query->have_posts() ) : $query->the_post(); ?>
					...
					<div class="col-<?php echo esc_attr($columns_mobile); ?> col-md-<?php echo esc_attr($columns_tablet); ?> col-lg-<?php echo esc_attr($columns); ?> mb-2">
						<?php get_template_part( 'edd_templates/block-edd-content-shop' ); ?>
					</div>
