...
function larisdigital_tutor_customize_controls_archive( $controls ) {
	...
	$controls['larisdigital_tutor_heading_archive_sidebar_layout'] = array(
		...
		'setting'  => 'larisdigital_tutor_heading_archive_sidebar_layout',
		'section'  => 'larisdigital_tutor_section_archive',
		'type'     => 'heading',
	);

	$controls['larisdigital_tutor_archive_sidebar_layout'] = array(
		'label'    => esc_html__( 'Sidebar Layout', 'larisdigital-wp' ),
		'setting'  => 'larisdigital_tutor_archive_sidebar_layout',
		'section'  => 'larisdigital_tutor_section_archive',
		'type'     => 'select',
		'choices'  => array(
	...
	$controls['larisdigital_tutor_archive_sidebar_width'] = array(
		'label'    => esc_html__( 'Sidebar Width', 'larisdigital-wp' ),
		'setting'  => 'larisdigital_tutor_archive_sidebar_width',
		'section'  => 'larisdigital_tutor_section_archive',
		'type'     => 'select',
		'choices'  => array(
		...
		'active_callback' => 'larisdigital_tutor_callback_archive_sidebar_is_active',
	);

	$controls['larisdigital_tutor_archive_content_width'] = array(
		'label'    => esc_html__( 'Content Width', 'larisdigital-wp' ),
		'setting'  => 'larisdigital_tutor_archive_content_width',
		'section'  => 'larisdigital_tutor_section_archive',
		'type'     => 'select',
		'choices'  => array(
			'' => esc_html__( 'Default', 'larisdigital-wp' ),
		...
		'active_callback' => 'larisdigital_tutor_callback_archive_sidebar_is_not_active',
	);
	...
	$controls['larisdigital_tutor_course_filter_layout'] = array(
		'label'				=> esc_html__( 'Course Filter Position', 'larisdigital-wp' ),
		'setting'			=> 'larisdigital_tutor_course_filter_layout',
		'section'			=> 'larisdigital_tutor_section_archive',
		'type'				=> 'radio',
		'choices'			=> array(
			''				=> esc_html__( 'Left', 'larisdigital-wp' ),
			'right'			=> esc_html__( 'Right', 'larisdigital-wp' ),
		),
		'active_callback'	=> 'larisdigital_tutor_callback_course_filters_is_active',
	);

	$controls['larisdigital_tutor_course_filter_width'] = array(
		'label'    			=> esc_html__( 'Course Filter Width', 'larisdigital-wp' ),
		'setting'  			=> 'larisdigital_tutor_course_filter_width',
		'section'			=> 'larisdigital_tutor_section_archive',
		'type'     			=> 'select',
		'choices'  			=> array(
			'' 				=> esc_html__( 'Default', 'larisdigital-wp' ),
	...
	$controls['larisdigital_tutor_archive_filter_bar_disable'] = array(
		'label'				=> esc_html__( 'DISABLE course top filter (ordering dropdown)', 'larisdigital-wp' ),
		'setting'  			=> 'larisdigital_tutor_archive_filter_bar_disable',
		'section'			=> 'larisdigital_tutor_section_archive',
		'type'				=> 'checkbox',
	);
	...
	$controls['larisdigital_tutor_heading_archive_pagination'] = array(
		...
		'setting'			=> 'larisdigital_tutor_heading_archive_pagination',
		'section'			=> 'larisdigital_tutor_section_archive',
		'type'				=> 'heading',
		'priority'			=> 99,
	);
...
function larisdigital_tutor_customize_controls_course( $controls ) {
	...
	// $controls['larisdigital_tutor_heading_course_sidebar_layout'] = array(
	// 	'label'    => esc_html__( 'Sidebar Layout', 'larisdigital-wp' ),
	// 	'description' 		=> '<p class="larisdigital-alert larisdigital-alert-with-icon">
	// 							<span class="dashicons dashicons-admin-tools"></span> <a href="javascript:wp.customize.panel( \'widgets\' ).focus();">'.esc_html__( 'CLICK HERE to setup / manage widgets when sidebar is available', 'larisdigital-wp' ).'</a>
	// 							</p>',
	// 	'setting'  => 'larisdigital_tutor_heading_course_sidebar_layout',
	// 	'section'  => 'larisdigital_tutor_section_course',
	// 	'type'     => 'heading',
	// );

	// $controls['larisdigital_tutor_course_sidebar_layout'] = array(
	// 	'label'    => esc_html__( 'Sidebar Layout', 'larisdigital-wp' ),
	// 	'setting'  => 'larisdigital_tutor_course_sidebar_layout',
	// 	'section'  => 'larisdigital_tutor_section_course',
	// 	'type'     => 'select',
	// 	'choices'  => array(
	// 		'none' => esc_html__( 'No Sidebar', 'larisdigital-wp' ),
	...
	// $controls['larisdigital_tutor_course_sidebar_width'] = array(
	// 	'label'    => esc_html__( 'Sidebar Width', 'larisdigital-wp' ),
	// 	'setting'  => 'larisdigital_tutor_course_sidebar_width',
	// 	'section'  => 'larisdigital_tutor_section_course',
	// 	'type'     => 'select',
	// 	'choices'  => array(
	// 		'' => esc_html__( 'Default', 'larisdigital-wp' ),
	...
	// 		'6' => esc_html__( '6/12 Grid', 'larisdigital-wp' ),
	// 	),
	// 	'active_callback' => 'larisdigital_tutor_callback_course_sidebar_is_active',
	// );

	// $controls['larisdigital_tutor_course_content_width'] = array(
	// 	'label'    => esc_html__( 'Content Width', 'larisdigital-wp' ),
	// 	'setting'  => 'larisdigital_tutor_course_content_width',
	// 	'section'  => 'larisdigital_tutor_section_course',
	// 	'type'     => 'select',
	// 	'choices'  => array(
	// 		'' => esc_html__( 'Default', 'larisdigital-wp' ),
	...
	// 		'6' => esc_html__( '6/12 Grid', 'larisdigital-wp' ),
	// 	),
	// 	'active_callback' => 'larisdigital_tutor_callback_course_sidebar_is_not_active',
	// );

	$controls['larisdigital_tutor_heading_course_layout'] = array(
		'label'    => esc_html__( 'Single Course Layout', 'larisdigital-wp' ),
		'setting'  => 'larisdigital_tutor_heading_course_layout',
		'section'  => 'larisdigital_tutor_section_course',
		'type'     => 'heading',
	);

	$controls['larisdigital_tutor_course_layout'] = array(
		'label'				=> esc_html__( 'Single Course Layout', 'larisdigital-wp' ),
		'setting'			=> 'larisdigital_tutor_course_layout',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'radio',
		'choices'			=> array(
	...
	$controls['larisdigital_tutor_course_cta_width'] = array(
		'label'    => esc_html__( 'CallToAction Width', 'larisdigital-wp' ),
		'setting'  => 'larisdigital_tutor_course_cta_width',
		'section'  => 'larisdigital_tutor_section_course',
		'type'     => 'select',
		'choices'  => array(
			'' => esc_html__( 'Default', 'larisdigital-wp' ),
	...
	$controls['larisdigital_tutor_disable_course_author'] = array(
		'label'				=> esc_html__( 'DISABLE Course Author', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_author',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_level'] = array(
		'label'				=> esc_html__( 'DISABLE Course Level', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_level',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_share'] = array(
		'label'				=> esc_html__( 'DISABLE Course Share', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_share',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_duration'] = array(
		'label'				=> esc_html__( 'DISABLE Course Duration', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_duration',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_total_enrolled'] = array(
		'label'				=> esc_html__( 'DISABLE Course Total Enrolled', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_total_enrolled',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_update_date'] = array(
		'label'				=> esc_html__( 'DISABLE Course Update Date', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_update_date',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_progress_bar'] = array(
		'label'				=> esc_html__( 'DISABLE Course Progress Bar', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_progress_bar',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_about'] = array(
		'label'				=> esc_html__( 'DISABLE Course About', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_about',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_description'] = array(
		'label'				=> esc_html__( 'DISABLE Course Description', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_description',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_benefits'] = array(
		'label'				=> esc_html__( 'DISABLE Course Benefits', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_benefits',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_announcements'] = array(
		'label'				=> esc_html__( 'DISABLE Course Announcements', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_announcements',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_enable_q_and_a_on_course'] = array(
		'label'				=> esc_html__( 'ENABLE Question and Answer', 'larisdigital-wp' ),
	...
	$controls['larisdigital_tutor_display_course_instructors'] = array(
		'label'				=> esc_html__( 'ENABLE Instructor Info', 'larisdigital-wp' ),
	...
	$controls['larisdigital_tutor_disable_course_review'] = array(
		'label'				=> esc_html__( 'DISABLE Course Review', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_review',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_material'] = array(
		'label'				=> esc_html__( 'DISABLE Course Material', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_material',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_requirements'] = array(
		'label'				=> esc_html__( 'DISABLE Course Requirements', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_requirements',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
	...
	$controls['larisdigital_tutor_disable_course_target_audience'] = array(
		'label'				=> esc_html__( 'DISABLE Course Target Audience', 'larisdigital-wp' ),
		'setting'  			=> 'disable_course_target_audience',
		'setting_type' 		=> 'option_mod',
		'setting_db' 		=> 'tutor_option',
		'section'			=> 'larisdigital_tutor_section_course',
		'type'				=> 'checkbox',
...
function larisdigital_tutor_callback_course_filters_is_active() {
	...
	return isset( $tutor_option['course_archive_filter'] ) && $tutor_option['course_archive_filter'] ? true : false;
}
