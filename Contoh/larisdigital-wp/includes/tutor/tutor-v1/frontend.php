...
add_filter('tutor_get_template_path', 'larisdigital_tutor_get_template_path', 10, 2 );
function larisdigital_tutor_get_template_path( $template_location, $template ) {
	$template_location = str_replace('/larisdigital-wp/tutor/', '/larisdigital-wp/tutor/tutor-v1/', $template_location);
...
function larisdigital_tutor_custom_style( $style ) {
	if ( 
		...
		$style = $style.'.tutor-loop-course-container { padding-top:0; padding-bottom: 0; }';
	}
