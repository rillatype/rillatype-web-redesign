...
function larisdigital_tutor_sejoli_monetization_options( $options ) {
	$options['sejoli'] = esc_html__('Sejoli', 'larisdigital-wp');
	return $options;
}
...
<div class="tutor-option-field-row">
	...
	<div class="tutor-option-field">
		...
		<label>
			...
			<?php _e('Paid (please create/select a Sejoli product for this course)', 'larisdigital-wp'); ?>
		</label>
		<br/>
		<label>
			<input type="radio" name="tutor_course_price_type" value="free"  <?php checked($_tutor_course_price_type, 'free'); ?> >
			<?php _e('Free', 'larisdigital-wp'); ?>
		</label>
	</div>
</div>
...
<div class="tutor-option-field-row">
	...
	<div class="tutor-option-field">
		...
		<select name="_tutor_course_product_id" class="tutor_select2" style="min-width: 300px;">
			<option value="-1"><?php _e('Select a Sejoli Product', 'larisdigital-wp'); ?></option>
			<?php
...
function larisdigital_tutor_sejoli_check_enroll() {
	...
	$has_content_access = tutils()->has_enrolled_content_access('courses');
