...
<?php if ( !$enable_spotlight_mode ) : ?>
    <div class="ld-tutor-single-lesson">
        <div class="container">
<?php endif; ?>
    ...
    <div class="tutor-lesson-sidebar">
        ...
        <div class="tutor-sidebar-tabs-wrap">
            <div class="tutor-tabs-btn-group">
                <a href="#tutor-lesson-sidebar-tab-content" class="active"> <i class="tutor-icon-education"></i> <span> <?php esc_html_e('Lesson List', 'larisdigital-wp'); ?></span></a>
            </div>
        ...
        <div class="tutor-single-page-top-bar">
            <div class="tutor-topbar-item tutor-hide-sidebar-bar">
                ...
                <a href="<?php echo get_the_permalink($course_id); ?>" class="tutor-topbar-home-btn">
                    <i class="tutor-icon-home"></i> <?php echo __('Go to Course Home', 'larisdigital-wp') ; ?>
                </a>
            </div>
