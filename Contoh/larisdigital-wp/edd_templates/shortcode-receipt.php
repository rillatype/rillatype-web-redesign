...
if ( ! function_exists( 'EDD' ) ) {
	include_once('shortcode-receipt_edd2.php');
	return;
}
...
?>
<table id="edd_purchase_receipt" class="edd-table table table-striped mb-4">
...
<table id="edd_purchase_receipt_products" class="edd-table table table-striped mb-4">
	<thead class="thead-dark">
