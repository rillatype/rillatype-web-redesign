<?php
/**
 * Template Name: Page Builder (Boxed Width)
 ...
 */
add_filter( 'body_class', 'larisdigital_body_class_template_builder_boxed' );
function larisdigital_body_class_template_builder_boxed( $classes ) {
	...
	$classes[] = 'template-builder-boxed';
	return $classes;
}
